...
from xyz.modules.database.fingerprints import fetch_fingerprints, listen_to_postgres
...
vm_socket = socketio.Client(transport='websocket', reconnection=True, reconnection_attempts=5, reconnection_delay=2)
...
try:
    vm_socket.connect('wss://https://isadora.ai')  # Replace with the VM's Socket.IO URL
