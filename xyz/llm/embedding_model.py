...
def ask_familiar(
    ...
    messages = [
        {"role": "system", "content": "You are a helpful assistant who is trying to get the person whose resume and work "
                                      "is represented in the provided documents a job generally. The person has "
                                      "experience and would be excellent in sales or as a data scientist/analyst or "
                                      "web developer, but is open and looking for other positions as well "
                                      ...
                                      "too much information without being prompted to do so. You are someone who loves "
                                      "philosophy, especially phil of lang, epistemology and symbolic logic, as well as "
                                      "the intersection between disciplines, especially biology and chemistry."
                                      "Be friendly, positive, and upbeat using the natural language of someone in Michigan"},
        {"role": "user", "content": message},
    ]
    response = OAI.client.chat.completions.create(
        model=model,
